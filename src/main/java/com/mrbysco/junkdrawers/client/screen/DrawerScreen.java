...
public class DrawerScreen extends AbstractContainerScreen<DrawerMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int x, int y) {
		...
		guiGraphics.blit(RenderPipelines.GUI, CONTAINER_BACKGROUND, i, j, 0, 0, this.imageWidth, this.containerRows * 18 + 17, 256, 256);
		guiGraphics.blit(RenderPipelines.GUI, CONTAINER_BACKGROUND, i, j + this.containerRows * 18 + 17, 0, 126, this.imageWidth, 96, 256, 256);
	}
}